...
| `python/tox.ini` | Exact filename beating the generic INI extension | Sections incl. `testenv:lint`, indented `deps`/`commands` multiline values preserved |
| `python/.flake8` | Exact filename | flake8 options, comma lists, per-file-ignores continuation preserved |
